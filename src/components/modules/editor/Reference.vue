  ...
  <transition name="fade">
    <div class="layui-layer-page layui-layer-prompt edit-content" v-show="isShow">
      ...
      <div class="layui-layer-btn">
        <button type="button" class="layui-btn layui-btn-normal" @click.prevent="submit()">确认</button>
        <button type="button" class="layui-btn layui-btn-primary" @click.prevent="cancel()">取消</button>
      </div>
    </div>
  </transition>
</template>
...
export default {
  ...
  methods: {
    submit () {
      ...
      this.$emit('addEvent', this.referenceContent)
      this.cancel()
    },
    cancel () {
